...
public class Order implements Serializable{
	...
	@JoinColumn(name = "client_id") // informa o nome da coluna de chave estrangeira
	private User client;
	
	@OneToMany(mappedBy = "id.order")
	private Set<OrderItem> items = new HashSet<>();
	
	@OneToOne(mappedBy = "order", cascade = CascadeType.ALL) // mapeando as duas entidades para ter o mesmo ID no OneToOne é obrigatorio
	...
	public OrderStatus getOrderStatus() {
		return OrderStatus.valueOf(orderStatus); // pega o numero inteiro interno da classe e converte em OrderStatus.
	}
